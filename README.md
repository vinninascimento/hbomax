...
<a href="https://vinninascimento.github.io/hbomax/">
...
O projeto possui como intuito aplicar os conceitos abordados na Trilha de CSS da <a href="https://dio.me">DIO</a>, ministrada pela instrutora <a href="https://github.com/vinninascimento">Vinicius Nascimento</a>.
...
Como parte do desafio final da Trilha de CSS, o desenvolvedor deve reproduzir [esse projeto](https://vinninascimento.github.io/hbomax/), sem realizar uma consulta do código final do site, presente na branch `master` deste repositório.
...
O resultado final do projeto deve contemplar todas as [features](#features) presentes no <a href="https://vinninascimento.github.io/hbomax/">resultado final</a>.
...
Você pode acessar ao resultado final do projeto [clicando aqui](https://vinninascimento.github.io/hbomax/).


<h2 id="author">💻 Autor</h2>
<p>
    <img align=left margin=10 width=80 src="https://avatars.githubusercontent.com/u/87505121?v=4"/>
    <p>&nbsp&nbsp&nbspVinicius Nascimento<br>
    &nbsp&nbsp&nbsp&nbsp;<a href="https://github.com/vinninascimento">GitHub</a>&nbsp;|&nbsp;<a href="https://www.linkedin.com/in/thisvinicius">LinkedIn</a>&nbsp;|</p>
</p>
<br/><br/>
<p>

---
⌨️ por [Vinicius Nascimento](https://github.com/vinninascimento) 😊